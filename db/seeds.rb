...
# Criando nossos Users de exemplo
...
User.create name: 'Wesley', status: :active, kind: :salesman, email: 'wesleysartori@unochapeco.edu.br', password: 123456
User.create name: 'Jiovan', status: :active, kind: :manager, email: 'jiiovan@unochapeco.edu.br', password: 123456
